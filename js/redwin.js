...
redwinState.prototype ={

    create: function () {

        game.physics.startSystem(Phaser.Physics.ARCADE);

        winnersprite = game.add.sprite(game.world.centerX, 230, "redwinner");
        winnersprite.anchor.set(0.5);

        losersprite = game.add.sprite(game.world.centerX, 415, "blueloser");
